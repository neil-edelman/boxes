...
\subsection{Tree Structure in Memory}

non-empty complete binary tree. semi-implicit: lose the ability to go up the tree; have to have the size \ref{star-3:mem}
