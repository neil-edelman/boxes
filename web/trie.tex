...
\usepackage[pdf,singlefile,tmpdir]{graphviz} % \detokenize to use utf-8
...
\begin{figure}
	\centering
	\caption{Split the trie to put four items.\label{star-4}}
...
<TABLE BORDER="0" CELLBORDER="0">
	<TR>
		<TD ALIGN="LEFT" BORDER="0" PORT="0">↓<FONT COLOR="Gray">Algieba</FONT></TD>
		<TD>0</TD>
		<TD>1</TD>
		<TD>0</TD>
		<TD BGCOLOR="White" BORDER="1">0</TD>
	...
	<TR>
		<TD ALIGN="LEFT" BORDER="0" PORT="1">↓<FONT COLOR="Gray">Regulus</FONT></TD>
		<TD>0</TD>
		<TD>1</TD>
		<TD>0</TD>
		<TD BGCOLOR="Black" COLOR="White" BORDER="1"><FONT COLOR="White">1</FONT></TD>
