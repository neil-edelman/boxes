...
Figure~\ref{timing} shows the common case where one has an ordered map of \code{int} to pointer. It is of straight insertion of random elements, (not in any order.)
