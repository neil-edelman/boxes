...
A B-tree can be superior to a single node-based approach used in red-black or AVL trees, used by many languages to implement ordered sets or maps. It is not without cost, since this is now not a stable data-structure.
