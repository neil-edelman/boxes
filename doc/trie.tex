...
set log y
plot \
"../timing/timing4.tsv" using 1:($3/1000):($4/1000) with errorlines title "10000 keys" ls 1, \
"../timing/timing5.tsv" using 1:($3/1000):($4/1000) with errorlines title "100000 keys" ls 3, \
"../timing/timing6.tsv" using 1:($3/1000):($4/1000) with errorlines title "1000000 keys" ls 4
\end{gnuplot}
\caption{Order.}%
\label{timing}%
\end{figure}%
