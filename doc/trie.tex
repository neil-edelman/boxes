...
Because of alignment, \code{skip} must also be one or three octets. We have made it one octet. One might also play around with the balance of \code{left} and \code{skip} ranges, but without a specific use case, this has been deemed acceptable. The size of the tree fits nicely in the front, giving a maximum index size of 512 octets.
