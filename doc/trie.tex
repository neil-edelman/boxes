...
This trie asks: what is the minimum number of bits, and the closest to the start, to distinguish the string keys? Then it encodes that information in two bytes {\it per} entry in a complete binary tree; the tree is therefore an index to the data.
