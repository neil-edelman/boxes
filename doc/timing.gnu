...
"graph/o128.tsv" using 1:($2/$1*1000):($3/$1*1000) with errorlines title "o128" ls 3, \
"graph/o257.tsv" using 1:($2/$1*1000):($3/$1*1000) with errorlines title "o257" ls 4, \
"graph/o2049.tsv" using 1:($2/$1*1000):($3/$1*1000) with errorlines title "o2049" ls 5
