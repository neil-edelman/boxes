/** 2016 Neil Edelman, distributed under the terms of the MIT License;
 ...
 index of an element is constant. Not compatible with {ARRAY_TAIL_DELETE}.
 ...
 compatible with {ARRAY_FREE_LIST}.
...
#endif /* --> */
#if defined(ARRAY_FREE_LIST) && defined(ARRAY_TAIL_DELETE) /* <-- error */
#error ARRAY_FREE_LIST and ARRAY_TAIL_DELETE are both defined.
#endif /* error --> */
