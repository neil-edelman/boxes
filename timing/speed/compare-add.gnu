...
set log x
plot \
"graph/table-add.tsv" using 1:($2/$1):($3/$1) with errorlines title "hash table add" ls 2, \
"graph/tree-add.tsv" using 1:($2/$1):($3/$1) with errorlines title "tree add" ls 4, \
"graph/trie-add.tsv" using 1:($2/$1):($3/$1) with errorlines title "trie add" ls 5
