...
set log x
plot \
"graph/table-look.tsv" using 1:($2/$1):($3/$1) with errorlines title "hash table look" ls 2, \
"graph/tree-look.tsv" using 1:($2/$1):($3/$1) with errorlines title "tree look" ls 4, \
"graph/trie-look.tsv" using 1:($2/$1):($3/$1) with errorlines title "trie look" ls 5
